...
This is Part A of the verification work: programme frameworks, guided play, game-based learning,
executive function and transfer, and digital/screens. Part B appends the remaining rows (the 2026
maths meta-analysis, the 2026 maths systematic review, and the phonological-awareness item).
